                                                ...
                                                <a href="/?g=afro" class="list-item list-hover r rounded">
                                                    ...
                                                    <div class="list-content text-center">
                                                        <div class="list-body"><a href="/?g=afro"
                                                                class="list-title title ajax h-1x">Afro beat </a></div>
                                                    </div>
                                                </a>
                                            </div>
                                                ...
                                                <a href="/?g=afro" class="list-item list-hover r rounded">
                                                    ...
                                                    <div class="list-content text-center">
                                                        <div class="list-body"><a href="/?g=dancehall"
                                                                                  class="list-title title ajax h-1x">Dancehall </a></div>
                                                    </div>
                                                </a>
                                            </div>
                                                ...
                                                <a href="/?g=afro" class="list-item list-hover r rounded">
                                                    ...
                                                    <div class="list-content text-center">
                                                        <div class="list-body"><a href="/?g=reggaeton"
                                                                                  class="list-title title ajax h-1x">Reggaeton </a></div>
                                                    </div>
                                                </a>
                                            </div>
                                                ...
                                                <a href="/?g=afro" class="list-item list-hover r rounded">
                                                    ...
                                                    <div class="list-content text-center">
                                                        <div class="list-body"><a href="/?g=trap"
                                                                                  class="list-title title ajax h-1x">Trap </a></div>
                                                    </div>
                                                </a>
                                            </div>
                                        ...
                                        <div class="list-item list-overlay r">
                                            ...
                                            <div class="list-content p-5 text-center">
                                                <div class="list-body"><a href="item.detail.html#"
                                                        ...
                                                        next purchase
                                                    </a><button class="btn btn-sm btn-light text-dark btn-rounded mx-3"
                                                                >I want this </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <div class="list-item r">
                                                ...
                                                <div class="list-content">
                                                    <div class="list-body"><a href="#"
                                                            class="list-title title ajax h-1x">SICKO MODE </a>
                                                        <a
                                                                href="#418888835"
                                                                class="list-subtitle d-block text-muted h-1x subtitle ajax"> <i
                                                                    data-feather="activity"></i>100 BPM | #dancehall #afro </a></div></div>
                                                </div>
                                            </div>
                                        </div>
